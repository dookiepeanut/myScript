...
getgenv().petsGoConfig = {
    ...
    SELL_GIFT_BAG = false, SELL_GIFT_BAG_MIN = 10, SELL_GIFT_BAG_PERCENTAGE = 0.93,
    ...
    SELL_GOD_POTION = false, SELL_GOD_POTION_PERCENTAGE = 0.93,

    -- Eggs
    -- SELL_EGG_MIN : [Doesn't apply to Huge/Hype Egg (Default MIN 1)]
    SELL_EGG = false, SELL_EGG_MIN = 3000, SELL_EGG_PERCENTAGE = 0.94,
